...
document.getElementById('inscriptionForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        // CORRECTION : Rétablissement du lien de suivi
        document.getElementById('trackingLink').href = '../acteurs-login/?id=' + ppId;
