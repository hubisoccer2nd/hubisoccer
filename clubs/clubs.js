...
function getFilteredClubs() {
  ...
  const statut = statutFilter ? statutFilter.value : 'actif'; // <-- CORRECTION : valeur par défaut "actif"
...
document.addEventListener('DOMContentLoaded', () => {
  applyNosClubsTranslations();
  // Force le filtre à "actif" par défaut
  if (statutFilter) {
    statutFilter.value = 'actif';
  }
