/* ============================================================
   HubISoccer — academie-revenus-setup.js
   Configuration du HubIS Wallet – Académie Sportive
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) {
        userName.textContent = userProfile.full_name || userProfile.display_name || 'Académie';
    }
...
async function checkExistingWallet() {
    ...
    if (data && data.status === 'active') {
        ...
        setTimeout(function() {
            window.location.href = 'academie-revenus.html';
        }, 1500);
        return true;
    }
    return false;
...
function displayUserInfo() {
    ...
    if (nameEl) {
        nameEl.textContent = userProfile.full_name || 'Académie';
    }
    if (roleEl) {
