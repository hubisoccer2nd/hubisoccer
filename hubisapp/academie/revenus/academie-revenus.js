/* ============================================================
   HubISoccer — academie-revenus.js
   Dashboard principal du HubIS Wallet – Académie Sportive
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) userName.textContent = userProfile.full_name || userProfile.display_name || 'Académie';
...
async function loadWallet() {
    ...
    if (!data || error) {
        ...
        setTimeout(function() { window.location.href = 'academie-revenus-setup.html'; }, 1500);
        return null;
    }
