/* ============================================================
   HubISoccer — agent-commissions-setup.js
   Configuration du HubIS Wallet – Agent FIFA
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) {
        userName.textContent = userProfile.full_name || userProfile.display_name || 'Agent';
    }
...
async function checkExistingWallet() {
    ...
    if (data && data.status === 'active') {
        ...
        setTimeout(function() {
            window.location.href = 'agent-commissions.html';
        }, 1500);
        return true;
    }
    return false;
...
function displayUserInfo() {
    ...
    if (nameEl) {
        nameEl.textContent = userProfile.full_name || 'Agent';
    }
    if (roleEl) {
