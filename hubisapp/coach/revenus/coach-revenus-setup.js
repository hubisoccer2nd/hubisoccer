/* ============================================================
   HubISoccer — coach-revenus-setup.js
   Configuration du HubIS Wallet – Coach / Entraîneur
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) {
        userName.textContent = userProfile.full_name || userProfile.display_name || 'Coach';
    }
...
async function checkExistingWallet() {
    ...
    if (data && data.status === 'active') {
        ...
        setTimeout(function() {
            window.location.href = 'coach-revenus.html';
        }, 1500);
        return true;
    }
    return false;
...
function displayUserInfo() {
    ...
    if (nameEl) {
        nameEl.textContent = userProfile.full_name || 'Coach';
    }
    if (roleEl) {
