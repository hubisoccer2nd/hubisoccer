/* ============================================================
   HubISoccer — coach-revenus.js
   Dashboard principal du HubIS Wallet – Coach / Entraîneur
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) userName.textContent = userProfile.full_name || userProfile.display_name || 'Coach';
...
async function loadWallet() {
    ...
    if (!data || error) {
        ...
        setTimeout(function() { window.location.href = 'coach-revenus-setup.html'; }, 1500);
        return null;
    }
