/* ============================================================
   HubISoccer — gt-revenus-setup.js
   Configuration du HubIS Wallet – Gestionnaire Tournoi
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) {
        userName.textContent = userProfile.full_name || userProfile.display_name || 'Gestionnaire';
    }
...
async function checkExistingWallet() {
    ...
    if (data && data.status === 'active') {
        ...
        setTimeout(function() {
            window.location.href = 'gt-revenus.html';
        }, 1500);
        return true;
    }
    return false;
...
function displayUserInfo() {
    ...
    if (nameEl) {
        nameEl.textContent = userProfile.full_name || 'Gestionnaire';
    }
    if (roleEl) {
