/* ============================================================
   HubISoccer -- gt-settings.js
   Page Paramètres - Espace Gestionnaire de Tournoi
   Section Paiements et Suppression du compte absentes
   (la suppression vit deja dans Mon Profil, pas de doublon).
   ============================================================ */
'use strict';
...
async function saveSettings(e) {
    ...
    else { showToast('Paramètres enregistrés. ✅', 'success'); Object.assign(userProfile, updates); }
}
...
function exportData() {
    ...
    a.href = url;
    a.download = 'hubisoccer_' + (userProfile.hubisoccer_id || 'export') + '.json';
    a.click();
