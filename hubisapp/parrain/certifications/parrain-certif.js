/* ============================================================
   HubISoccer -- parrain-certif.js
   Espace Parrain - Diplomes & Certificats
   Adapte de foot-certif.js : porte d'acces role_code='FOOT'
   retiree (aucun autre fichier parrain ne l'utilise), types de
   document adaptes au contexte parrain (professionnel/associatif/
...
async function loadProfile() {
    ...
    userProfile = data;
    document.getElementById('userName').textContent = userProfile.full_name || userProfile.display_name || 'Parrain';
    updateAvatarUI();
    return userProfile;
}
...
function renderCertificates() {
    ...
    container.innerHTML = certificates.map(cert => {
        ...
        if (cert.type === 'professionnel') icon = 'fa-briefcase';
        else if (cert.type === 'associatif') icon = 'fa-hands-helping';
        return `
...
function initUploadForm() {
    ...
    document.getElementById('certForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const filePath = `certifications/parrain/${fileName}`;
