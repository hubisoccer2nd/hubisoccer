...
async function init() {
    ...
    try {
        ...
        // LOT A — si on ne peut PAS vérifier qu'une communauté
        // existe déjà, on ne laisse pas croire qu'il n'y en a pas :
        // la personne en créerait une deuxième.
        ...
        toast('Impossible de vérifier si tu as déjà une communauté — ' + raison +
              '. Ouvre le fil avant de créer, pour ne pas en faire une deuxième.', 'warning');
    }
