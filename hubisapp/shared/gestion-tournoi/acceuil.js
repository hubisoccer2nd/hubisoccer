...
async function loadTournamentsList() {
    ...
    return data.map(function(t) {
        return {
            ...
            type: t.supabaseAuthPrive_gt_types ? t.supabaseAuthPrive_gt_types.name : '',
            typeLabel: t.supabaseAuthPrive_gt_types ? t.supabaseAuthPrive_gt_types.label : '',
            sport: t.supabaseAuthPrive_gt_sports ? t.supabaseAuthPrive_gt_sports.name : ''
        };
    });
}
