...
window.GTStats = (function () {
    ...
    function ligneVide(idJoueur, idEquipe) {
        var l = {
            player_id: idJoueur,
    ...
    function calculerDepuisEvenements(options) {
        ...
        function ligne(idJoueur, idEquipe) {
            if (!idJoueur) return null;
            if (!lignes[idJoueur]) lignes[idJoueur] = ligneVide(idJoueur, idEquipe);
            if (idEquipe && !lignes[idJoueur].team_id) lignes[idJoueur].team_id = idEquipe;
            return lignes[idJoueur];
        }
    ...
    // note de 6.00 sur un joueur reste sur le banc serait un
    // mensonge.
    // ═══════════════════════════════════════════════════════
