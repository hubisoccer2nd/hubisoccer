/* ============================================================
   CORRECTION : le fichier commencait par le caractere « r »
   isole, juste avant ce commentaire :  r/* ...
   En JavaScript, « r » seul est une expression evaluee au
   chargement : elle levait ReferenceError: r is not defined
   et TOUT le script s'arretait la. Aucune fonction de la
   page de rapport n'etait donc jamais definie.
   ============================================================ */
/* ============================================================
...
function getMatchIdFromUrl() {
    ...
    // ------------------------------------------------------------
    //  Cette page ne lisait que ?match_id=, alors que la fiche du
    //  match (match-details.html) transmet ?id=. On arrivait donc
    //  toujours ici sans identifiant et la page affichait
    //  « Aucun match specifie » a chaque ouverture.
    //
    //  getMatchId() (session-gt.js) accepte ?match_id=, ?match= et
    //  ?id= : les deux conventions fonctionnent desormais.
    // ============================================================
    if (typeof getMatchId === 'function') return getMatchId();
