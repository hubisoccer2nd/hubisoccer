...
async function loadRegistrations() {
    ...
    const { data, error } = await supabaseClient
        ...
        .select('id, status, created_at, tournament:supabaseAuthPrive_gt_tournaments!inner(id, name, start_date, end_date, location, sport_id, supabaseAuthPrive_gt_sports!inner(name))')
...
function renderRegistrations(registrations) {
    ...
    container.innerHTML = registrations.map(function(reg) {
        ...
        const sport = tournament.supabaseAuthPrive_gt_sports ? tournament.supabaseAuthPrive_gt_sports.name : '—';
