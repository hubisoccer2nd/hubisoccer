...
async function loadMyTournaments() {
    ...
    const { data, error } = await supabaseClient
        ...
        .select('id, name, description, start_date, end_date, location, status, type_id, sport_id, supabaseAuthPrive_gt_types!inner(name, label), supabaseAuthPrive_gt_sports!inner(name)')
        // created_by est la SEULE colonne de proprietaire de la table
        // (verifie sur le schema reel). Ce filtre etait donc correct
        // depuis le debut : le probleme venait de create-tournament.js
        // qui ne renseignait jamais cette colonne.
...
function renderTournaments(tournaments) {
    ...
    container.innerHTML = tournaments.map(function(t) {
        ...
        const typeLabel = t.supabaseAuthPrive_gt_types ? t.supabaseAuthPrive_gt_types.label : '—';
        const sportName = t.supabaseAuthPrive_gt_sports ? t.supabaseAuthPrive_gt_sports.name : '—';
