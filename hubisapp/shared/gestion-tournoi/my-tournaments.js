...
async function loadMyTournaments() {
    ...
    const { data, error } = await supabaseClient
        ...
        .select('id, name, description, start_date, end_date, location, status, prize_pool, type_id, sport_id, ' + TBL_TYPES + '!inner(name, label), ' + TBL_SPORTS + '!inner(name)')
    ...
    // Comptes de participants par tournoi
    for (const t of allMyTournaments) {
