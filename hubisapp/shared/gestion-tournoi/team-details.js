...
async function loadTeamMatches() {
    ...
    const { data, error } = await supabaseClient
        ...
        .select('id, round, team_a_id, team_b_id, score_a, score_b, match_date, status, tournament_id, supabaseAuthPrive_gt_tournaments!inner(name)')
    ...
    data.forEach(function(match) {
        ...
        matchCard.innerHTML =
            ...
            '<div class="match-footer">' +
                '<span class="match-tournament">' + (match.supabaseAuthPrive_gt_tournaments?.name || '') + '</span>' +
