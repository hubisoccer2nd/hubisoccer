/* ============================================================
   HubISoccer — staff-cv.js
   CV Professionnel · Staff Médical
   Corps · Âme · Esprit
   ============================================================ */
'use strict';
...
let scoutingData = null;   // table supabaseAuthPrive_staff_medical_scouting
const ROLE_CODE  = 'MEDIC';
const ROLE_LABEL = 'Staff Médical';
const SCOUTING_TABLE = 'supabaseAuthPrive_staff_medical_scouting';
const SCOUTING_FK    = 'staff_medical_id';
    ...
    <div class="cv-preview-wrap" id="cvPreviewContent">
        <div class="cv-preview-header" style="background:#4B0082;">
            ...
            <div>
                ...
                <div class="cv-preview-role">Staff Médical — HubISoccer</div>
        ...
        <div class="cv-preview-footer">
            <span class="cv-footer-logo">HubISoccer — Staff Médical</span>
...
async function downloadPDF(){
    ...
    showLoader();
    try{
        var opt={margin:.5,filename:'CV_staff_medical_HubISoccer.pdf',image:{type:'jpeg',quality:.98},html2canvas:{scale:2},jsPDF:{unit:'in',format:'a4',orientation:'portrait'}};
...
function initLogout(){
    document.querySelectorAll('#logoutLink,#logoutLinkSidebar').forEach(function(l){
        l.addEventListener('click',async function(e){e.preventDefault();await supabaseClient.auth.signOut();window.location.href='../../authprive/users/login.html?role=MEDIC';});
    });
}
/* FIN : UI UTILS */
