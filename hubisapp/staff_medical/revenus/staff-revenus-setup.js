/* ============================================================
   HubISoccer — staff-revenus-setup.js
   Configuration du HubIS Wallet – Staff Médical
   ============================================================ */
...
function updateNavbarAvatar() {
    ...
    if (userName) {
        userName.textContent = userProfile.full_name || userProfile.display_name || 'Staff Médical';
    }
...
async function checkExistingWallet() {
    ...
    if (data && data.status === 'active') {
        ...
        setTimeout(function() {
            window.location.href = 'staff-revenus.html';
        }, 1500);
        return true;
    }
    return false;
...
function displayUserInfo() {
    ...
    if (nameEl) {
        nameEl.textContent = userProfile.full_name || 'Staff Médical';
    }
    if (roleEl) {
