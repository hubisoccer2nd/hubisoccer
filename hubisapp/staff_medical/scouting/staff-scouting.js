/* ============================================================
   HubISoccer -- staff-scouting.js
   Page Scouting - Espace Staff Medical
   ------------------------------------------------------------
   ...
   donnees fausses.
   ------------------------------------------------------------
   "Suivre cet athlete" envoie vers Mes Athletes Suivis avec
   ?id=hubisoccer_id -- contrairement a Mes Proteges cote parrain,
   un athlete suivi ici correspond a un vrai compte joueur (badge
   Pass Medical, wellness, etc. n'ont de sens que rattaches a un
   profil reel), donc lien par ID plutot que pre-remplissage nom.
   ============================================================ */
'use strict';
...
function suivreAthlete() {
    if (!selectedProfile) { return; }
    window.location.href = '../athletes/staff-athletes.html?id=' + encodeURIComponent(selectedProfile.hubisoccer_id);
}
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    document.getElementById('btnSuivreAthlete')?.addEventListener('click', suivreAthlete);
