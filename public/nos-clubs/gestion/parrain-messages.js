    ...
    try {
        ...
        if (!data || data.length === 0) {
            ...
            container.innerHTML = data.map(msg => {
                const isParrain = msg.expediteur_id === 'parrain' || msg.expediteur_id === 'admin';
                const senderLabel = isParrain ? 'Vous / Admin' : 'Talent / Coach';
                return `
                    <div class="message ${isParrain ? 'sent' : 'received'}">
