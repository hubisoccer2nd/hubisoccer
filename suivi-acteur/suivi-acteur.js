/* DEBUT : suivi-acteur/suivi-acteur.js */
// ========== SUIVI-ACTEUR.JS ==========
...
// ========== DÉBUT : TRADUCTIONS (FR/EN UNIQUEMENT) ==========
const translations = {
    fr: {
...
async function loadInscription(ppId) {
    ...
    try {
        ...
        initQuill();  // Initialiser Quill après affichage du bloc
        return data;
    } catch (err) {
        console.error(err);
...
function initQuill() {
    if (replyQuill) return; // déjà initialisé
...
/* FIN : suivi-acteur/suivi-acteur.js */